 ...
 */
definition(
	name: "Sonos Say Stuff",
	namespace: "TLH",
	author: "Terry Honn",
	description: "Play sounds on Sonos.",
	category: "My Apps",
...
// TODO - End Centralize
//192.168.1.101/media/sounds/
//media/sounds/
private loadText() {
	switch ( actionType) {
		case "Please disable the alarm":
			state.sound = [uri: "https://s3.amazonaws.com/honnhouse/sounds/please_disable_the_alarm.mp3", duration: "15"]
			break;
		case "Comm Channel":
			state.sound = [uri: "https://s3.amazonaws.com/honnhouse/sounds/30sec_commchannel.mp3", duration: "30"]
			break;
		case "Washer Done":
			state.sound = [uri: "https://s3.amazonaws.com/honnhouse/sounds/washerdone2.mp3", duration: "15"]
			break;
		case "Fire Alarm":
			state.sound = [uri: "http://s3.amazonaws.com/smartapp-media/sonos/alarm.mp3", duration: "17"]
			break;
		case "Car Blip":
			state.sound = [uri: "https://s3.amazonaws.com/honnhouse/sounds/caralarm.mp3", duration: "4"]
			break;
		case "A door opened":
